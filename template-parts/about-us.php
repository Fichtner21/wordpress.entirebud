...
<div class="template-about">
  ...
  <div class="template-about__bottom">
    <div class="template-about__bottom--baner" style="background-image: url('<?php echo get_sub_field('template_about_bg')['url'] ?>')"></div> 
    <div class="template-about__bottom--center">
      <div class=""><?php echo get_field('template_about_text'); ?></div>
      <a href="<?php echo get_field('template_about_link') ?>"><?php echo get_field('template_about_btn'); ?></a>
    </div>   
  </div>
</div>
